        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneImage = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    GPlayImage = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    AppStoreImage = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorProfessions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthCenterInfos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FooterPhone = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
                    Email = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    FooterEmail = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    AboutUs = table.Column<string>(type: "ntext", nullable: true),
                    AboutUsTitle = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Image = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    DoctorProfessionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Doctors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Doctors_DoctorProfessions_DoctorProfessionId",
                        column: x => x.DoctorProfessionId,
                        principalTable: "DoctorProfessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlogCategoryToBlogs_BlogCategories_BlogCategoryId",
            ...
            migrationBuilder.CreateTable(
                name: "DoctorSocialToDoctors",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DoctorId = table.Column<int>(type: "int", nullable: false),
                    DoctorSocialId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorSocialToDoctors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorSocialToDoctors_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorSocialToDoctors_DoctorSocials_DoctorSocialId",
                        column: x => x.DoctorSocialId,
                        principalTable: "DoctorSocials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogCategoryToBlogs_BlogCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctors_DoctorProfessionId",
                table: "Doctors",
                column: "DoctorProfessionId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorSocialToDoctors_DoctorId",
                table: "DoctorSocialToDoctors",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorSocialToDoctors_DoctorSocialId",
                table: "DoctorSocialToDoctors",
                column: "DoctorSocialId");
        }
